...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/adam)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/adam
```

A live public deployment of this template is available at [https://adam.templates.workers.dev](https://adam.templates.workers.dev)
